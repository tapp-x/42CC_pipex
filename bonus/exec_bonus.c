...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/18 10:34:20 by tappourc          #+#    #+#             */
/*   Updated: 2024/01/26 09:21:02 by tappourc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	last_exec(char *cmd, char **env, char *filename, char **av)
{
	...
	if (ft_strncmp(av[1], "here_doc", 8) == 0)
		fd_out = open(filename, O_CREAT | O_APPEND | O_WRONLY, 0644);
	else
